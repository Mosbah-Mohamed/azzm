      ...
      <ul>
        ...
        <li><a href="#" aria-label="breadcrumb" target="_blank" rel="noopener"><nuxt-link
              :to="localePath('/coursesFilter')">{{
                $t('navbar.diploma') }}</nuxt-link></a></li>
      </ul>
    </div>
          ...
          <div class="col-lg-4 col-12">
            ...
            <div class="filter_box">
              <h3>
                ...
                <span>{{ $t('courses.diploma_filtering') }}</span>
              </h3>
              ...
              <div class="all_check_boxes">
                ...
                <form>
                  ...
                  <div class="form-group">
                    <button type="button" class="main--btn" @click="getData">{{ $t('courses.show_diploma') }}</button>
                  </div>
                ...
                <div class="card_course">
                  ...
                  <div class="card_content">
                    ...
                    <div class="course_link">
                      <nuxt-link :to="localePath({ path: `/singleDiploma/${item.id}` })">
  ...
  methods: {
    ...
    async getData() {
      ...
      try {
        ...
        return await this.$axios.get('courses?type=1', {
          params: {
